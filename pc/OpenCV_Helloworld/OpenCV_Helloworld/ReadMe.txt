========================================================================
   APPLICATION CONSOLE : Vue d'ensemble du projet OpenCV_Helloworld
========================================================================

AppWizard a créé cette application OpenCV_Helloworld pour vous.

Ce fichier contient un résumé des éléments contenus dans chaque fichier qui
constitue votre application OpenCV_Helloworld.


OpenCV_Helloworld.vcxproj
...
OpenCV_Helloworld.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé OpenCV_Helloworld.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
